    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        if (state.is(Blocks.END_PORTAL_FRAME)) {
            if (!level.isClientSide() && level instanceof ServerLevel serverLevel) {
                ...
                serverLevel.sendParticles(new BlockParticleOption(ParticleTypes.BLOCK, Blocks.END_PORTAL_FRAME.defaultBlockState()), center.x, center.y, center.z, 30, 0.25, 0.25, 0.25, 0);
            }

...
public class Items {
    ...
    public static final RegistryObject<Item> FLIMSY_DOOR = register("flimsy_door", () -> new FlimsyDoorItem(com.accbdd.reclamation_util.register.Blocks.FLIMSY_DOOR.get(), new Item.Properties()));
